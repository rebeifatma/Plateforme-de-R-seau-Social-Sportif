 ...
 */
final class Version20231221093307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT NOT NULL, DROP create_at');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', DROP category_id');
    }
}
